...
class WarcraftAPI(BaseAPI):
    ...
    def _request_gateway(self, resource: str, parameters: dict, modified_since: Optional[datetime] = None) -> dict:
        ...
        if self.classic and "classic" not in namespace:
            raise BlizzardAPIException(f"{resource} ({namespace}) is not a valid Warcraft Classic request.")
    ...
    def azerite_essence_search(self, **kwargs) -> None:
        """
    ...
    def connected_realm_search(self, **kwargs) -> None:
        """
    ...
    def creature_search(self, **kwargs) -> None:
        """
    ...
    def journal_encounter_search(self, **kwargs) -> None:
        """
    ...
    # Media Search APIs
    def media_search(self, **kwargs) -> None:
        """
    ...
    def mount_search(self, **kwargs) -> None:
        """
    ...
    def realm_search(self, **kwargs) -> None:
        """
    ...
    def spell_search(self, **kwargs) -> None:
        """
